...
import { GraduationProjectComponent } from 'app/entities/graduation-project/graduation-project.component';
...
describe('Component Tests', () => {
  describe('GraduationProject Management Component', () => {
    let comp: GraduationProjectComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GraduationProjectComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new GraduationProject(123)],
            headers
          })
        )
      );
      ...
      expect(comp.graduationProjects[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { IntershipComponent } from 'app/entities/intership/intership.component';
...
describe('Component Tests', () => {
  describe('Intership Management Component', () => {
    let comp: IntershipComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IntershipComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.interships[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

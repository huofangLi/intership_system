...
import { AbsenceRecordComponent } from 'app/entities/absence-record/absence-record.component';
...
describe('Component Tests', () => {
  describe('AbsenceRecord Management Component', () => {
    let comp: AbsenceRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AbsenceRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.absenceRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

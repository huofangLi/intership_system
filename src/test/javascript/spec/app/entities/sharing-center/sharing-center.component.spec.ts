...
import { SharingCenterComponent } from 'app/entities/sharing-center/sharing-center.component';
...
describe('Component Tests', () => {
  describe('SharingCenter Management Component', () => {
    let comp: SharingCenterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SharingCenterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sharingCenters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { AlarmEventComponent } from 'app/entities/alarm-event/alarm-event.component';
...
describe('Component Tests', () => {
  describe('AlarmEvent Management Component', () => {
    let comp: AlarmEventComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlarmEventComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alarmEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

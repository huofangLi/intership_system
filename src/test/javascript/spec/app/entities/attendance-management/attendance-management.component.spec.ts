...
import { AttendanceManagementComponent } from 'app/entities/attendance-management/attendance-management.component';
...
describe('Component Tests', () => {
  describe('AttendanceManagement Management Component', () => {
    let comp: AttendanceManagementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AttendanceManagementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AttendanceManagement(123)],
            headers
          })
        )
      );
      ...
      expect(comp.attendanceManagements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
export class StudentService {
  ...
  protected convertDateFromClient(student: IStudent): IStudent {
    const copy: IStudent = Object.assign({}, student, {
      createdTime: student.createdTime != null && student.createdTime.isValid() ? student.createdTime.toJSON() : null,
      modifyTime: student.modifyTime != null && student.modifyTime.isValid() ? student.modifyTime.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((student: IStudent) => {
        student.createdTime = student.createdTime != null ? moment(student.createdTime) : null;
        student.modifyTime = student.modifyTime != null ? moment(student.modifyTime) : null;
      });
    }
    return res;
  }
